...
/**
 * This class represents a default policy attachment
 */
public class DefaultPolicyAttachment {
    String name;
    String description;
    List<String> labels;
    ...
    public void setPolicyNames(List<String> policyNames) {
        this.policyNames = new ArrayList<>(policyNames);
    }
}
