...
return null;
    ...
    private List<RuleValidationResultDTO> ruleValidationResults = new ArrayList<RuleValidationResultDTO>();
   ...
   **/
  public ArtifactGovernanceResultDTO ruleValidationResults(List<RuleValidationResultDTO> ruleValidationResults) {
  ...
  @ApiModelProperty(value = "List of rule validation information.")
      @Valid
  @JsonProperty("ruleValidationResults")
  public List<RuleValidationResultDTO> getRuleValidationResults() {
    return ruleValidationResults;
  }
  public void setRuleValidationResults(List<RuleValidationResultDTO> ruleValidationResults) {
    this.ruleValidationResults = ruleValidationResults;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(artifactId, artifactGovernanceResult.artifactId) &&
        ...
        Objects.equals(ruleValidationResults, artifactGovernanceResult.ruleValidationResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(artifactId, artifactName, status, ruleValidationResults);
  }
  ...
  public String toString() {
    ...
    sb.append("    ruleValidationResults: ").append(toIndentedString(ruleValidationResults)).append("\n");
    sb.append("}");
    return sb.toString();
  }
