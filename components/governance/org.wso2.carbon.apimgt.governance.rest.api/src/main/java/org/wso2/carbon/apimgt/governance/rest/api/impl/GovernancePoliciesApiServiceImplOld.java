 ...
 */
public class GovernancePoliciesApiServiceImplOld implements GovernancePoliciesApiService {
    ...
    public Response createGovernancePolicy(GovernancePolicyInfoWithRulesetIdsDTO governancePolicyInfoWithRulesetIdsDTO,
        ...
        try {
            ...
            GovernancePolicy governancePolicyInfo = policyManager.createGovernancePolicy(organization,
    ...
    public Response getGovernancePolicyById(String policyId, MessageContext messageContext) throws GovernanceException {
        ...
        GovernancePolicy policyInfo = policyManager.getGovernancePolicyByID(organization, policyId);
    ...
    public Response updateGovernancePolicyById(String policyId, GovernancePolicyInfoWithRulesetIdsDTO
        ...
        GovernancePolicy updatedPolicyInfo = policyManager.updateGovernancePolicy
